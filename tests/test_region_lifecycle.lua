...
do
  local region = fibers.Region.new('lifecycle-region')
  local h = fibers.Region.handle('lifecycle-owned')
  local phases = {}
...
do
  local region = fibers.Region.new('lifecycle-alias-region')
  local h = fibers.Region.handle('lifecycle-alias-owned')
  local moved, owned_by_to
  fibers.run(function()
    local to = fibers.Region.new('lifecycle-alias-target')
    fibers.perform(region:admit_op(h))
