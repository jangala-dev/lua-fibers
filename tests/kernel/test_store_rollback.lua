...
local root = trail:new_segment(1, {}, nil)
Journal.read(root, inherited_loc)
local lane = trail:new_segment(1, { { group_id = 1, mode = 'independent', lane = 1 } }, root)
...
local nested = trail:new_segment(1, { { group_id = 2, mode = 'independent', lane = 1 } }, lane)
