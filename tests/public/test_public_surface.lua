...
do
  ...
  assert_eq(type(FibersSocket.datagram_op), 'function', 'Socket exposes datagram option construction')
  assert_eq(type(FibersSocket.datagram), 'function', 'Socket exposes direct datagram construction')
  assert_eq(FibersSocket.udp_op, FibersSocket.datagram_op, 'UDP option alias is stable')
  assert_eq(FibersSocket.udp, FibersSocket.datagram, 'UDP direct alias is stable')
