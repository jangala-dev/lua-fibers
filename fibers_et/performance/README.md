...
The older `benchmarks/` scripts remain useful for broad compatibility and
facility-level measurements. `performance/` is the more controlled v1 suite: it
has explicit tiers, separates timing from diagnostics, records distributions and
supports machine-readable regression comparison.
