...
local life = fibers.Scope.new('life')
...
local life_b = fibers.Scope.new('b')
...
local from = fibers.Scope.new('from')
local to = fibers.Scope.new('to')
...
local match_from_a = fibers.Scope.new('match-a')
local match_from_b = fibers.Scope.new('match-b')
local match_to = fibers.Scope.new('match-to')
...
do
  local from_a = fibers.Scope.new('filter-a')
  local from_b = fibers.Scope.new('filter-b')
  local to = fibers.Scope.new('filter-to')
