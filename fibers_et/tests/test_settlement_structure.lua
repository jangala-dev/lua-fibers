  ...
  rt:spawn_raw(function()
    rt:perform(
      life:raw_region():admit_op(
        fibers.Region.Owned.tree(
          parent,
          K,
          { fibers.Region.Owned.item(child, K, { role = 'child', settle_name = 'phase-test' }) },
...
do
  ...
  rt:spawn_raw(function()
    rt:perform(life:raw_region():admit_op(fibers.Region.Owned.item(h, function()
