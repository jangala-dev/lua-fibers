...
local Op = fibers.Op
local Index = fibers.Index
local Region = fibers.Region
local Task = fibers.Task

-- Region operations should compose after a premise solution frame.  The item is
...
-- Effects emitted after a premise frame should see concrete committed payloads and
...
-- Task spawn should remain a post-commit effect when it follows a premise frame.
...
print('tests/test_region_task_effect_frames.lua: ok')
