-- Ordered Index premises.
-- These tests exercise the premise substrate beyond rendezvous: a resource
-- resolver can allocate concrete values and contribute one shared proposal.
...
local function test_two_parallel_pop_first_premises_get_distinct_concrete_values()
...
local function test_parallel_pop_last_premises_get_distinct_tail_values()
  local rt = new_runtime()
...
local function test_empty_index_premise_uses_absence_fallback()
  local rt = new_runtime()
...
local tests = {
  test_two_parallel_pop_first_premises_get_distinct_concrete_values,
  test_parallel_pop_last_premises_get_distinct_tail_values,
  ...
  test_empty_index_premise_uses_absence_fallback,
...
print('tests/test_premise_index.lua: ok')
