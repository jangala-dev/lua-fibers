...
rt2:spawn_raw(function()
  ...
  rt2:perform(life_b:retire_op(task))
...
rt3:spawn_raw(function()
  ...
  rt3:perform(life_events:retire_op(t))
end, 'events-root')
local st3 = rt3:run()
...
rt4:spawn_raw(function()
  ...
  rt4:perform(to:retire_op(handed))
end, 'handoff-root')
local st4
...
rt_match:spawn_raw(function()
  ...
  rt_match:perform(match_from_a:retire_op(task_a))
  rt_match:perform(match_to:retire_op(task_b))
...
rt_settle:spawn_raw(function()
  ...
  rt_settle:perform(settle_life:retire_op(settle_task))
